...
**Already automatic (no command):** `git push` **dev** / **development** updates `sync/git-push-log.md` and `sync/last-commit-code.md` via `.githooks/pre-push`.

## Use this flow

1. Read and apply `.cursor/skills/obsidian-auto-sync/SKILL.md`.
